...
class MaterialProgressDrawable extends Drawable implements Animatable {
    private static final String TAG = Logger.makeLogTag(MaterialProgressDrawable.class);
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            Logger.v(TAG, "onDraw: startAngle=" + startAngle + " sweep=" + sweepAngle + " mCurrentColor=" + mCurrentColor + " " + arcBounds.bottom);
